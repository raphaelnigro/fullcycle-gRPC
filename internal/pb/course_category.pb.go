...
type CreateCaregoryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateCaregoryRequest) Reset() {
	*x = CreateCaregoryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateCaregoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateCaregoryRequest) ProtoMessage() {}

func (x *CreateCaregoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateCaregoryRequest.ProtoReflect.Descriptor instead.
func (*CreateCaregoryRequest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{1}
}

func (x *CreateCaregoryRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateCaregoryRequest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x72,
	...
	0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x72,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x19, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x43, 0x61, 0x72, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CreateCaregoryRequest)(nil), // 1: pb.CreateCaregoryRequest
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	1, // 1: pb.CategoryService.CreateCaregory:input_type -> pb.CreateCaregoryRequest
	2, // 2: pb.CategoryService.CreateCaregory:output_type -> pb.CategoryResponse
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CreateCaregoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
